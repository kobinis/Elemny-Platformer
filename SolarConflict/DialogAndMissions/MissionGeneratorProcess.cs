...
namespace SolarConflict
{
    ...
    class MissionGeneratorProcess : GameProcess, IEmitter
    {
        ...
        public MissionGeneratorProcess(Agent missionGiver)
        {
        ...
        public Agent Emit(GameEngine gameEngine, Agent parent, FactionType faction, Vector2 refPosition, Vector2 refVelocity, float refRotation, float refRotationSpeed = 0, int maxLifetime = 0, float? size = default(float?), Color? color = default(Color?), float param = 0)
        {
            throw new NotImplementedException();
        }
