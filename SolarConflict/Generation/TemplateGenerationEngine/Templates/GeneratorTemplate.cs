...
{
    public class GeneratorTemplate : GenerationTemplate
    {
        ...
        public GeneratorTemplate() : base()
        {
           ...
           // AddParametereName(AURA_COLOR);
            ...
            _directoryName = "Generators";
            itemType = SlotType.Generator;
            MeterType = MeterType.Energy;
            MaxValueMeterType = MeterType.EnergyMaxValue;
            MeterImage = "Generator";
        }
        ...
        protected override void ParseAndAddEmitter(string[] parameters)
        {
            ...
            GeneratorData data = new GeneratorData(id);
            ...
            data.ItemData.SlotType = SlotType.Generator;
