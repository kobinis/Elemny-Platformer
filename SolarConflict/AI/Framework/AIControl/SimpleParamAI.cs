...
//{
//    [Serializable]
//    class SimpleParamAI : IAgentControl
//    {
...
//                if (targetDis > 15)  //MyMath.Bern((targetDis - minDis) / disRange - 0.1f))
//                {
...
//                /*if (ship.GetMeterValue(MeterType.Energy) / ship.get < 0.1f)
//                    attack = false;

//                if (!attack)
//                {
//                    targetDeg += MathHelper.Pi;
//                    if (ship.currentEnergy / ship.totalEnergy > 0.7f)
//                        attack = true;
//                    if (ship.currentEnergy / ship.totalEnergy > 0.5f && MyMath.rand.Next(50) == 0)
//                        attack = true;
//                    controlSignals = BitVector.AddBit(controlSignals, (int)ControlSignals.Up);
//                }*/
