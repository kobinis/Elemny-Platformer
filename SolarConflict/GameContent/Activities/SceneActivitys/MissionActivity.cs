...
namespace SolarConflict.GameContent.Activities.SceneActivitys {
    public class MissionActivity : SceneActivity
    {
        ...
        public GuiControl MakeMissionControl(Mission mission, Scene scene) {
            ...
            var toggle = new ImageControl(unselectedSprite, Vector2.Zero, Vector2.One * 60 * GuiManager.Scale);
            ...
            if (mission.IsDismissable) {
                ImageControl deleteControl = new ImageControl(Sprite.Get("trash1"), Vector2.Zero, Vector2.One * 50 * GuiManager.Scale);
