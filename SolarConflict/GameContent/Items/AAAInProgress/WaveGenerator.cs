...
//        {
//            WeaponData weaponData = new WeaponData("Wave Generator");
...
//            weaponData.ShotEmitter = MakeShot(5, 1);
...
//            profile.UpdateSize = new UpdateSizeSpeed(1, 20);
//            profile.InitMaxLifetimeID = Utility.Frames(1.5f).ToString();
//            profile.Mass = 40f;
//            //profile.CollisionSpec = new CollisionInfo(220f, 200f);            
//            profile.CollisionSpec = new CollisionSpec(damage, ImpactType.Velocity, 0.1f);
