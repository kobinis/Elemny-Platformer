...
namespace SolarConflict.GameContent.Ships
{
    class SmallShip11
    {
        ...
        {
            Agent ship = ShipQuickStart.Make("SmallShip11", 0, true);
            ...
            ship.ItemSlotsContainer.AddAgentSlot(SlotType.Turret, ship.SizeType, new Vector2(-32, -32), 0, ControlSignals.Action2);
            ship.ItemSlotsContainer.AddAgentSlot(SlotType.Turret, ship.SizeType, new Vector2(-32, 32), 0, ControlSignals.Action2);
            ship.ItemSlotsContainer.AddAgentSlot(SlotType.Turret, ship.SizeType, new Vector2(32, -32), 0, ControlSignals.Action2);
            ship.ItemSlotsContainer.AddAgentSlot(SlotType.Turret, ship.SizeType, new Vector2(32, 32), 0, ControlSignals.Action2);
            ...
            ShipQuickStart.AddBasicGearSlots(ship, false, 2, 1, 2);
