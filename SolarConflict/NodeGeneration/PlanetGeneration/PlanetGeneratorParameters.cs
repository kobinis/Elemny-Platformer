...
namespace SolarConflict.NodeGeneration.PlanetGeneration
{
    ...
    public static class PlanetParam
    {
        ...
        //Atmosphere values
        public static Vector2 atmoIntLimits = new Vector2(0.8f, 1.6f);
        ...
        /*
        /// <summary>Generates planet of given type</summary>
        public PlanetData GeneratePlanet(PlanetType planetType, int seed)
        {
        ...
        public PlanetData GenerateBarren(int seed, Random rnd)
        {
            
            //Generate atmosphere color
