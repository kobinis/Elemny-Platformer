...
{
    class GreenSmokePS : ParticleSystemAdv
    {
        float MinRotateSpeed;
        float MaxRotateSpeed;

        float MinStartSize = 6;
        float MaxStartSize = 14;
        ...
        public GreenSmokePS(ContentManager content, GraphicsDevice graphicsDevice)
        ...
        protected override void InitializeSettings()
        {
            ...
            LutName = "Shaders/GPULuts/GreenFire";
        ...
        {
            Effect effect = content.Load<Effect>("Shaders/greenSmokePE");
            ...
            Texture2D lut = content.Load<Texture2D>(LutName);
            parameters["Texture"].SetValue(texture);
            parameters["LUT"].SetValue(lut);
