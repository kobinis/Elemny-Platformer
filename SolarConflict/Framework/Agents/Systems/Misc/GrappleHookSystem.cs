...
//    [Serializable]
//    class GrappleHookSystem : AgentSystem
//    {
...
//        const float HarpoonRetractionFarAcceleration = 50f;
//        const float HarpoonRetractionNearAcceleration = 100f;
...
//        {
//            GrappleHookSystem system = MemberwiseClone() as GrappleHookSystem;
...
//        {
//            _camera = gameEngine.Camera;
//            if (_camera != null && _pixel == null)
//            {
//                _pixel = new SetPixel(DrawHarpoonPoint);
//            }
...
//                if (!_harpoonedObject.IsActive || _tetherTime <= 0 || !tryActivate)
//                {
...
//        {
//            if (_camera != null)
//                _camera.CameraDraw(_harpoonSprite, point, 0, 0.25f, color);
//        }
