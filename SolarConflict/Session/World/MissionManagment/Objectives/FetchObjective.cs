...
{
    /// <summary>
    /// FetchObjective - Acquire an Item and bring it to target, when completed item is consumed
    /// </summary>
    [Serializable]
    class FetchObjective : MissionObjective
    {
        ...
        public FetchObjective(GameObject target, float radiusOffset = 400, float radiusMult = 1, bool withSameShip = false, bool targetCanBeNonActive = false)
        {
            Target = target;
